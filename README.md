...
modelos ou texturas externos. A única exceção é a trilha principal, *Harvest Hush*
(`public/music/harvest-hush.mp3`), tocada em loop; se ela não carregar, a trilha procedural
assume. O build de arquivo único (`dist/cozy-zombie.html`) procura a música em `music/` ao lado.
